...
DEFAULT_DATABASES="postgres mysql mysql8 mariadb sqlite duckdb mongodb redis elasticsearch clickhouse memcached valkey dragonfly opensearch starrocks yugabytedb questdb ferretdb"
DEFAULT_CATEGORIES="postgres:sql mysql:sql mysql8:sql mariadb:sql sqlite:sql duckdb:sql mongodb:document redis:keyvalue elasticsearch:document clickhouse:sql memcached:cache valkey:keyvalue dragonfly:keyvalue opensearch:document starrocks:sql yugabytedb:sql questdb:sql ferretdb:document"
