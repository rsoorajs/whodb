...
Scratchpad is WhoDB's SQL workspace. It gives you page-based query organization, one or more query cells per page, query execution, result grids, action-query confirmations, and per-cell query history.
...
Type SQL into the editor and run it with either:

- The blue run button on the right side of the editor.
- `Cmd/Ctrl + Enter`.
