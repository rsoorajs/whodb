...
description: "Enable AWS, Azure, and GCP discovery in WhoDB"
---
...
Environment-defined providers are shown, but the UI does not allow deleting them.

## Reachability Still Matters

Discovery does not tunnel or proxy traffic for you. The WhoDB process still needs network access to the discovered endpoint.
