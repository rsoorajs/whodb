...
Cloud discovery does not use a separate query surface. It fills the standard login form with the discovered endpoint and database-specific metadata, then connects through the same flow as a manual login.
</Step>
</Steps>
