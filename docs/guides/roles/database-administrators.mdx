...
<Step title="Review Node Cards">
Click nodes to load columns when needed:

![Graph Node Card](/images/26-graph-view-node-details.png)

Node cards render metadata and loaded columns directly. Use the visible **Data** button to open the object's data page.
</Step>
</Steps>
