...
Click "Advanced Options" if you need special settings such as SSL/TLS certificates or database-specific options.
...
**For production databases:** Your administrator may ask you to set an SSL mode, provide certificates, or use a private network path to the database.
</Step>
<Step title="Connect">
