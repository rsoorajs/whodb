...
Features:
- Saves recent connection profiles locally in the browser you are using
- Quick reconnect from connection history
- Edit saved connections
- Delete old connections

<Note>
Browser storage is local to that browser profile. Use a dedicated browser profile or clear saved connections on shared machines.
</Note>
</Accordion>
...
- Manual web connection profiles can be persisted in browser storage
...
- Manually entered web connection profiles can be persisted in browser local storage
- Environment-defined profiles keep credentials in server-side environment configuration
- Browser storage security depends on the browser profile and operating system account protecting that machine

**Re-authentication:**
- Clear saved connections or use a separate browser profile on shared machines
